...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("mid.jpg"));
	...
	private void scare() {
		...
		//9. Find a scary sound and put it in the section5 package where you put your maze picture. You can find a sound on. Log in as leagueofamazing/code4life.
